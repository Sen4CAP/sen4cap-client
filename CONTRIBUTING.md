...
The Sen4CAP client welcomes contributions of any form
...
* Make sure test coverage stays close to 100% for any change.
  Use `pytest --cov=sen4cap_client --cov-report=html` to verify.
...
The code style of the Sen4CAP-client equals the default settings 
...
3. 1st-party library module imports using absolute paths, 
   e.g., `from sen4cap_client.a.b import c`. 
